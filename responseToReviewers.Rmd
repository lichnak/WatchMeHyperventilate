...
> _\textcolor{blue}{We thank the reviewer for the general positive comments concerning our work.  We also
...
one of the top predictive modalities. Descriptive statistics on the
lesions are also necessary: how big were the lesions, how many lesions
were found in each patient (the range 1-20 is not sufficiently
...
WMH needs). There was no feature selection process all the features were
included as predictors. A similar pitfall if found on pg. 6 ln 56, where
...
explained with the available features. The pipeline also seem to be
...
then it is referred to as Atropos in the next page. It is unclear what is
³the first set of images² in pg. 9, or if there is a second set. Also,
mathematical formulas seem superfluous, particularly since it takes more
...
> _\textcolor{blue}{It was a grammatical mistake, not a question of
...
is also explained in Results. Also, it is unclear why finding which
direction of space is informative for the segmentation process would be a
``sanity check.''
...
> _\textcolor{red}{Get rid of the paragraphs in question.  Need to redo evaluation
to discuss.}_
...
> _\textcolor{red}{Similar concerns were voiced by Reviewer 1.  We appreciate
