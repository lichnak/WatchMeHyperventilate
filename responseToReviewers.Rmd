...
2. Second, the manuscript has no results. All the results section is [sic] focused
...
> _\textcolor{red}{Nick---Add a table for each patient and get all this
information before doing the evaluation.}_
