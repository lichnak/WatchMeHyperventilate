...
hyperintensity segmentation.  \textcolor{red}{Perhaps the spatial specification of deep
...
an additional MRF spatial prior.  In Figure 2, the voting maps are labeled as
...
In Figure 3 are the segmentation comparisons derived from manual segmentations of the same
...
in training data.  On the left of Figure 3 are the improvement in Dice values over all white
...
right side of Figure 3 that the total lesion load volume illustrates a few subjects that are
