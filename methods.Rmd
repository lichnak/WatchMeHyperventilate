...
derived as part of the registration process, we then register the voxel index locations
back to the space of the individual subject.  These index images are then warped back to
the space of the individual subject.  Note that this is similar in motivation to the work
