...
\textcolor{black}{In Figure 5 we provide the segmentation evaluations derived from the leave-one-out evaluation
...
\textcolor{black}{Smaller lesions ($< 12$ voxels) are more difficult
...
* \textcolor{black}{Stage 1}

    * \textcolor{black}{sensitivity} = 0.70 $\pm$ 0.34

    * \textcolor{black}{PPV} = 0.42 $\pm$ 0.36

    * \textcolor{black}{$F_1$} = 0.47 $\pm$ 0.36

    * \textcolor{black}{relative volume difference} = 43 $\pm$ 38\%

* \textcolor{black}{Stage 2}

    * \textcolor{black}{sensitivity} = 0.68 $\pm$ 0.38

    * \textcolor{black}{PPV} = 0.51 $\pm$ 0.40

    * \textcolor{black}{$F_1$} = 0.52 $\pm$ 0.36

    * \textcolor{black}{relative volume difference} = 43 $\pm$ 26\%
...
![\textcolor{black}{Evaluation measures for both Stages of the leave-one-out protocol of the described protocol in the Methods
