...
voxel-based overlap measures (such as the Dice similarity coefficient), and lesion-based measures.}[@Garcia-Lorenzo:2013aa]\textcolor{blue}{.  For this work, due to the relatively small-size distribution}[^4] \textcolor{blue}{of the lesion load in our data cohort (see Table 1), we used
...
[^4]: \textcolor{blue}{For comparison, the training data set of
