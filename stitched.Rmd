...
are from multi-model optimal symmetric shape/intensity templates [@Tustison:2015aa] created from the public MMRR data set  [@landman2011] (cf Figure 3).
...
On the left of Figure 7 are the improvement in Dice values [@tustison2009],
